...
for i in base-t2 t2-model-specific-support apple-t2-audio-config apple-ibridge-dkms-git linux-t2 gpu-switch; do # apple-bce-dkms-git needs old gcc to build
	status=13
